...
# -----------------INFO TOP------------
lblinfo = Label(Tops, font=('aria', 30, 'bold'), text="Restaurant Management System", bg="darkblue", fg="white", bd=10,
                anchor='w')
...
def Ref():
    ...
    dinnercost = "P", str(
        '%.2f' % (adoboprice + adobongbaboyprice + hiponprice + karikariprice + paksiwprice + drinksprice))
...
txtmanok = Entry(f1, font=('ariel', 16, 'bold'), textvariable=adobongmanok, bd=6, insertwidth=4, bg="white",
                 justify='right')
...
txtbaboy = Entry(f1, font=('ariel', 16, 'bold'), textvariable=lechonbaboys, bd=6, insertwidth=4, bg="white",
                 justify='right')
...
txthipon = Entry(f1, font=('ariel', 16, 'bold'), textvariable=siniganghipon, bd=6, insertwidth=4, bg="white",
                 justify='right')
...
txtkarikari = Entry(f1, font=('ariel', 16, 'bold'), textvariable=paksiws, bd=6, insertwidth=4, bg="white",
                    justify='right')
...
txtpaksiw = Entry(f1, font=('ariel', 16, 'bold'), textvariable=karikaris, bd=6, insertwidth=4, bg="white",
                  justify='right')
...
txtService_Charge = Entry(f1, font=('ariel', 16, 'bold'), textvariable=Service_Charge, bd=6, insertwidth=4, bg="white",
                          justify='right')
...
btnTotal = Button(f1, padx=16, pady=8, bd=10, fg="white", font=('ariel', 16, 'bold'), width=10, text="TOTAL", bg="blue",
                  command=Ref)
